...
| Lệnh | Mô tả |
|---|---|
| `/new-channel language:[ngôn ngữ]` | Tạo nhóm dịch thuật mới |
| `/join-channel group:[nhóm] language:[ngôn ngữ]` | Thêm kênh vào nhóm |
| `/leave-channel group:[nhóm]` | Xóa kênh khỏi nhóm |
