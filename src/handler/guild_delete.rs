use poise::serenity_prelude::{Context, UnavailableGuild, Guild};
use sea_orm::EntityTrait;

use crate::{AppError, Data, entities::guild::Entity as GuildEntity};

pub async fn guild_delete(_ctx: &Context, data: &Data, incomplete: &UnavailableGuild, full: &Option<Guild>) -> Result<(), AppError> {
