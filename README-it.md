...
| `PUBLIC_BASE_URL` | No | URL base per aggiungere un badge ad anello arancione agli avatar |
...
```powershell
# Configurazione iniziale (installa Caddy + systemd)
.\deploy\deploy-gce.ps1 -Bootstrap -UploadEnv

# Per aggiornamenti del codice
